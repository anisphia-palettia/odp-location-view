    ...
    return (
        <>
            ...
            {groupDetail?.coordinates && (
                <h2>Total koordinat: {groupDetail.coordinates.length}</h2>
            )}
            <h2>Daftar Koordinat</h2>
                        ...
                        {filteredCoordinates?.map((coordinate, index) => {
                            ...
                            return (
                                <tr key={index} className="row" onMouseEnter={() => setHoverIndex(index)}>
                                    ...
                                    <td className='td'>{coordinate.latitude}</td>
                                    <td className='td'>{coordinate.longitude}</td>
